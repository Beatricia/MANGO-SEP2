...
public interface Client extends PropertyChangeSubject
{
  ...
  /**
   * The method is used to sent to the Server the MenuItem object
   * which should me add to  the system
   * @param menuItem the MenuItem to be sent
   */
  void addItem(MenuItem menuItem);
  /**
   * The method is used to sent to the Server the Request object
   * @param request the Request object to be sent
   */
  void sendRequest(Request request);
  /**
   * The method is used to sent to the Server the DailuMenuItem object
   * which should me add to the system
